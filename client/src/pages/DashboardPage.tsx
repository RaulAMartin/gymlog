    ...
    <AnimatedPage>
      <section>
        ...
        <div className="mt-6 grid gap-4 md:grid-cols-4">
          <article className="rounded-xl bg-white p-5 shadow-sm dark:bg-gray-800">
        ...
        <div className="mt-6 grid gap-4 md:grid-cols-2">
          ...
          <article className="rounded-xl bg-white p-6 shadow-sm dark:bg-gray-800">
            ...
            <div className="mt-4 flex flex-wrap gap-3">
              ...
              <Link
                to="/exercises"
                className="rounded-lg bg-gray-900 px-4 py-2 font-medium text-white transition hover:bg-gray-800 dark:bg-gray-700 dark:hover:bg-gray-600"
              >
                Ver ejercicios
              </Link>
              ...
              <Link
                to="/history"
                className="rounded-lg bg-gray-200 px-4 py-2 font-medium text-gray-900 transition hover:bg-gray-300 dark:bg-gray-700 dark:text-gray-100 dark:hover:bg-gray-600"
              >
                Ver historial
              </Link>
            </div>
